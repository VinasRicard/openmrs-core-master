...
public class User extends BaseOpenmrsObject implements java.io.Serializable, Attributable<User>, Auditable, Retireable {
	...
	public boolean hasPrivilege(String privilege) {
		logger.info("Checking if user: " + username + " has privilege: " + privilege);
	...
	public User addRole(Role role) {
		...
		if (!roles.contains(role) && role != null) {
			roles.add(role);
			logger.info("Adding role to user: " + role.getName() + " for username: " + username);
		}
	...
	public User removeRole(Role role) {
		if (roles != null) {
			roles.remove(role);
			logger.info("Removing role from user: " + role.getName() + " for username: " + username);
		}
	...
	public void setUserProperty(String prop, String value) {
		...
		logger.info("Setting property for user. " + "Property: " + key + " = " + value);
	}
	...
	public void removeUserProperty(String prop) {
		if (getUserProperties() != null && userProperties.containsKey(prop)) {
			logger.info("Removing property for user. " + "Property: " + key + " = " + value);
